  ...
  return (
    <div className="min-w-full h-auto">
      ...
      <div className="fixed bottom-0 text-custom-gray font-montserrat font-semibold text-sm left-0 right-0 bg-white p-4 flex items-center justify-center gap-4 border-t border-gray-300">
        <p className="hover:text-black duration-300 cursor-pointer">About</p>
        ...
        <p className="hover:text-black duration-300 cursor-pointer">Ads Info</p>
        <p className="hover:text-black duration-300 cursor-pointer">Blog</p>
        <p className="hover:text-black duration-300 cursor-pointer">Status</p>
        <p className="hover:text-black duration-300 cursor-pointer">Careers</p>
        <p className="hover:text-black duration-300 cursor-pointer">
          Brand Resources
        </p>
        <p className="hover:text-black duration-300 cursor-pointer">
